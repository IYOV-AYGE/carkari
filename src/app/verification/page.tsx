...
const L: Record<"fr" | "en", {
  ...
  fr: {
    ...
    form: {
      ...
      secLive: "5. Vérification que vous êtes bien présent",
      liveRequired: "Effectuez d'abord la vérification de présence (selfie animé).",
      live: {
        title: "Selfie de présence",
        intro: "Votre écran va s'illuminer de plusieurs couleurs pendant que la caméra filme votre visage, puis nous vous demanderons de tourner la tête. Cela prend 10 secondes et prouve qu'il s'agit bien d'une personne réelle, et non d'une photo ou d'une vidéo.",
        start: "Démarrer la vérification",
        holdStill: "Ne bougez pas, regardez l'écran",
        lookCenter: "Regardez droit devant",
        lookLeft: "Tournez la tête vers la gauche",
        lookRight: "Tournez la tête vers la droite",
        analysing: "Analyse en cours…",
        passed: "Présence confirmée.",
        failedTitle: "Vérification non concluante :",
        retry: "Recommencer",
        denied: "Accès à la caméra refusé. Autorisez la caméra puis réessayez.",
        unsupported: "Impossible de lancer la vérification sur cet appareil. Utilisez Chrome ou Safari sur votre téléphone.",
        virtualCam: "Caméra virtuelle détectée. Utilisez la caméra réelle de votre appareil.",
        reasons: {
          "screen or print suspected (light did not reflect)":
            "la lumière ne s'est pas reflétée normalement sur le visage (photo ou écran ?).",
          "no natural movement detected": "aucun mouvement naturel détecté.",
          "incomplete colour response": "la séquence n'a pas pu être mesurée entièrement.",
          "challenge expired": "délai dépassé, recommencez.",
          "challenge already used": "séquence déjà utilisée, recommencez.",
          "unknown challenge": "séquence invalide, recommencez.",
        },
      },
      cam: {
  ...
  en: {
    ...
    form: {
      ...
      secLive: "5. Proof you are really there",
      liveRequired: "Complete the liveness check first.",
      live: {
        title: "Liveness selfie",
        intro: "Your screen will flash a few colours while the camera films your face, then we'll ask you to turn your head. It takes 10 seconds and proves you are a real person rather than a photo or a video.",
        start: "Start the check",
        holdStill: "Hold still and look at the screen",
        lookCenter: "Look straight ahead",
        lookLeft: "Turn your head to the left",
        lookRight: "Turn your head to the right",
        analysing: "Analysing…",
        passed: "Liveness confirmed.",
        failedTitle: "Check inconclusive:",
        retry: "Try again",
        denied: "Camera access denied. Allow the camera, then try again.",
        unsupported: "This device can't run the check. Use Chrome or Safari on your phone.",
        virtualCam: "Virtual camera detected. Please use your device's real camera.",
        reasons: {
          "screen or print suspected (light did not reflect)":
            "the light did not reflect naturally on the face (photo or screen?).",
          "no natural movement detected": "no natural movement detected.",
          "incomplete colour response": "the sequence could not be measured fully.",
          "challenge expired": "took too long, please start again.",
          "challenge already used": "sequence already used, please start again.",
          "unknown challenge": "invalid sequence, please start again.",
        },
      },
      cam: {
