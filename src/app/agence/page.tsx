...
const L: Record<"fr" | "en", {
  ...
  fr: {
    ...
    form: {
      ...
      priceHour: "Prix par heure (MAD)",
      minHours: "Durée minimum",
      hourlyNote: "Les quads et jet skis se louent à l’heure.",
  ...
  en: {
    ...
    form: {
      ...
      priceHour: "Price per hour (MAD)",
      minHours: "Minimum duration",
      hourlyNote: "Quads and jet skis are rented by the hour.",
