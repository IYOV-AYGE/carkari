...
const fr = {
  nav: { cars: "Voitures", cities: "Villes", partner: "Devenir hôte", login: "Connexion", logout: "Déconnexion", dashboard: "Mon espace", theme: "Changer de thème clair / sombre" },
  hero: {
  ...
  cats: { all: "Tous", citadine: "Citadine", compacte: "Compacte", suv: "SUV", luxe: "Luxe", utilitaire: "Utilitaire", quad: "Quad / ATV", jetski: "Jet ski" },
  rows: {
  ...
  card: { perDay: "/ jour", perHour: "/ heure", seats: "places", verified: "vérifiée" },
  menu: {
    login: "Connexion", signup: "Créer un compte", partner: "Devenir hôte",
    dashboard: "Mon espace agence", myBookings: "Mes réservations", verification: "Vérification d'identité", admin: "Administration",
  ...
  auth: {
    ...
    submitSignupHost: "Créer mon compte hôte",
    hostTitle: "Vous inscrivez votre agence",
    hostBody:
      "Un seul compte CarKari sert pour tout. Créez-le (ou connectez-vous), et vous revenez directement au formulaire d'inscription de votre agence.",
    agencyQ: "Agence de location ?", agencyLink: "Devenir hôte",
...
const en: typeof fr = {
  nav: { cars: "Cars", cities: "Cities", partner: "Become a host", login: "Sign in", logout: "Sign out", dashboard: "My space", theme: "Switch light / dark theme" },
  hero: {
  ...
  cats: { all: "All", citadine: "City car", compacte: "Compact", suv: "SUV", luxe: "Luxury", utilitaire: "Van", quad: "Quad / ATV", jetski: "Jet ski" },
  rows: {
  ...
  card: { perDay: "/ day", perHour: "/ hour", seats: "seats", verified: "verified" },
  menu: {
    login: "Log in", signup: "Sign up", partner: "Become a host",
    dashboard: "My agency space", myBookings: "My bookings", verification: "Identity verification", admin: "Admin",
  ...
  auth: {
    ...
    submitSignupHost: "Create my host account",
    hostTitle: "You're registering your agency",
    hostBody:
      "One CarKari account covers everything. Create it (or sign in) and you'll come straight back to your agency application.",
    agencyQ: "Rental agency?", agencyLink: "Become a host",
