...
export function CarculatorWidget({ L }: { L: CarcLabels }) {
  ...
  return (
    <div className="mx-auto max-w-xl rounded-2xl border border-ink/10 bg-card p-8 shadow-sm">
...
{L.type}
      ...
      <div className="mt-6 space-y-2 rounded-xl bg-brand-50 dark:bg-ink/10 p-5 text-ink">
