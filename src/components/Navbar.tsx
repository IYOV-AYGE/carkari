    ...
    <header className="sticky top-0 z-40 border-b border-brand-950/10 bg-white/90 backdrop-blur">
      <nav className="mx-auto flex h-16 max-w-6xl items-center justify-between px-4">
        ...
        <div className="hidden items-center gap-6 text-sm font-medium text-brand-950/80 sm:flex">
          <Link href="/search" className="hover:text-brand-950">Voitures</Link>
          <Link href="/#villes" className="hover:text-brand-950">Villes</Link>
          <Link href="/#agences" className="hover:text-brand-950">Devenir partenaire</Link>
        </div>
